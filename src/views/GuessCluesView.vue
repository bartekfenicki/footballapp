  ...
  <div class="container">
    <transition name="fade" mode="out-in">
      <div v-if="!gameStarted" key="welcome" class="welcome-container">
        <h1 class="title">The Clues Game</h1>
        <p class="rules-heading">Here are the rules:</p>
        <ul class="rules-list">
          <li>You get six tries to guess the correct football player.</li>
          <li>You start with the player's nationality and age.</li>
     ...
     <transition name="slide">
      <GuessClues v-if="showGame" key="game" />
    </transition>
</template>
