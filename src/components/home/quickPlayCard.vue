...
<div class="container noselect">
  ...
  <div class="canvas">
    <div @click="navigateToTarget" class="tracker tr-1"></div>
    <div @click="navigateToTarget" class="tracker tr-2"></div>
    <div @click="navigateToTarget" class="tracker tr-3"></div>
    <div @click="navigateToTarget" class="tracker tr-4"></div>
    <div @click="navigateToTarget" class="tracker tr-5"></div>
    <div @click="navigateToTarget" class="tracker tr-6"></div>
    <div @click="navigateToTarget" class="tracker tr-7"></div>
    <div @click="navigateToTarget" class="tracker tr-8"></div>
    <div @click="navigateToTarget" class="tracker tr-9"></div>
    <div id="card">
      <div class="card-content">
        ...
        <div class="cyber-lines">
          ...
          <p id="prompt">{{ promptText }}</p>
          <div class="title">PLAY<br />NOW</div>
        ...
        <div class="subtitle">
          <span>HOVER UP AND CLICK </span>
          <span class="highlight">TO PLAY</span>
        </div>
...
function navigateToTarget() {
  if (props.targetPath) {
    ...
    console.warn('QuickPlayCard: targetPath prop is not defined.');
  }
}
</script>
<style scoped>
...
.title {
  ...
  width: 100%;
  padding-top: 20px;
  background: linear-gradient(45deg, #00ffaa, #37FF8B);
...
.highlight {
  color: #00ffaa;
  margin-left: 5px;
  background: linear-gradient(90deg, #5c67ff, #37FF8B);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
  font-weight: bold;
}
